...
public class ParticleMenu {
    ...
    private static List<ParticleItem> particleItems = new ArrayList<ParticleItem>();
    ...
    public static void loadFromConfig(){
        ...
        for(ParticleEffect particleEffect:ParticleEffect.values()){
            ...
            if(!config.contains(particleEffect.toString())){
                ...
                config.set(particleEffect.toString() + ".lore", Arrays.asList(new String[]{"Click to activate", "on your location"}));
